...
public class StatTest {
	...
	public enum TypeStat {
		LOGFC, FC, TSTUDENTTILING, TSTUDENT, LNFCWT, STDEVWT, MANNWHIT, PERMUT, SMIRNOV, BOOTSTRAP, CORR, SPEARCORR,
		LPE, FDRBH, FDRBY, FDRBONF, AUTO_BOTH, AUTO_GENEXPR, AUTO_TILING, ARRAYSCORR
	};
	...
	public double run(double[] vector1, double[] vector2) {
		try {
			...
			case SMIRNOV:
				...
				return test3.getSP();
			case BOOTSTRAP:
				TwoSampleBootstrapMeansTest test4 = new TwoSampleBootstrapMeansTest(vector1, vector2,
						vector1.length / 2);
				return test4.getSP();
			case CORR:
