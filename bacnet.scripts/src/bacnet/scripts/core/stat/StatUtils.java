...
public class StatUtils {
    ...
    // public static void pieChart(ArrayList<ExpressionMatrix> matrices) throws PartInitException{
    ...
    // }
    //
    // public static void histogram(ExpressionMatrix matrix) throws PartInitException{
    ...
    // *
    // * @param experiment
    // * @param afterNorm true if we want to load data which have been Median/HK norm<br>
    // * false if we want to load data with no Median/HK normalization
    // * @throws PartInitException
    // * @throws FileNotFoundException
    // * @throws IOException
    // */
    // public static void histogramTiling(Experiment experiment, boolean afterNorm) throws
    ...
    // * @throws IOException
    // */
    // public static void histogramGeneExpData(Experiment experiment,boolean afterNorm) throws
    // PartInitException, FileNotFoundException, IOException{
    ...
    // * @throws IOException
    // */
    // public static void boxplotTiling(Experiment experiment,boolean afterNorm) throws
    // PartInitException, FileNotFoundException, IOException{
    // ModelProvider.INSTANCE.setExpressionMatrixToDisplay(TilingData.loadandCombineTilingData(experiment,afterNorm));
    // IWorkbenchPage page =
    // Activator.getDefault().getWorkbench().getActiveWorkbenchWindow().getActivePage();
    ...
    // * @throws IOException
    // */
    // public static void boxplotGeneExpData(Experiment experiment,boolean afterNorm) throws
    // PartInitException, FileNotFoundException, IOException{
    // ModelProvider.INSTANCE.setExpressionMatrixToDisplay(GeneExpData.loadandCombineGeneExpData(experiment,afterNorm));
    // IWorkbenchPage page =
    // Activator.getDefault().getWorkbench().getActiveWorkbenchWindow().getActivePage();
    ...
    /**
     * Vector1 and vector2 are the values of all the probes contained in a specific genome element,
     * so:<br>
     * We calculate the difference within vector1-vector2 (probe by probe) And then calculate the median
     ...
     * We calculate the fold change by measuring the relative expression (or ratio) of the median
     * expression of vector1 and vector2
     * 
     * @param vector1
     * @param vector2
     * @param log if true we calculate relative expression, if false we "unlog" and calculate the ratio
     *        of expression
     * @return
     */
    ...
    /**
     * Use this fonction when comparing a vector to a median value already calculated <br>
