...
public class Expression {
    ...
    public static String PATH_ALLGENEXPR =
            Database.getTRANSCRIPTOMES_PATH() + File.separator + "AllGeneExpr";
    ...
    public static String PATH_ALLExpMatrix =
            Database.getTRANSCRIPTOMES_PATH() + File.separator + "AllExpMatrix";
    public static String PATH_ALLDataType =
            Database.getTRANSCRIPTOMES_PATH() + File.separator + "AllDataType";
    ...
    /**
     * Combine all Transcriptomes describe in <code>Expression</code> data, and return the combine
    ...
    public static void test() {
        ...
        bioCondList.add(ExpressionData.GENERAL_WT_NAME);
