...
/***************************************************************************
 *
 * PREDicting poly-A region and TERMinal splice acceptor for Leishmania Please
 * read manuscript for details : Smith, M., Blanchette, M., Papadopoulou, B.
 * Improving the prediction of mRNA extremities in the protozoan parasite
 * Leishmania. BMC Bioinformatics, 2008.
 *
 * INPUT : .FASTA formatted intergenic sequence, with 800 nt of coding sequence
 * at each extremity (i.e. last 800 nt of upstream gene and first 800 of
 * dowsntream gene) *must have 500A800.pssm in same directory as this script
 *
...
public class PredaTerm {
	...
	/**
	 * Please enter fasta file as argument, with 800 nucleotides flanking the
