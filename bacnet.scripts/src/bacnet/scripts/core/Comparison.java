...
public class Comparison {
    ...
    public static String PATH_DIFF_LISTS =
            Database.getDATA_PATH() + "Summary Comparison" + File.separator + "Diff_List";
    ...
    /**
     * For the list obtained in wizard panel, compute information and extract leftBC and rightBC
     * information. These 2 lists will then be used to calculate comparison
     * 
     * @param comparisonList
     */
