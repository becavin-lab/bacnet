...
public class GRNormalization {
     ...
     * <br>
     * 
     * It runs DNA reference normalization (Hubert et al.), it can uses also an additional reference
     * data for normalization (indicates by boolean normalization).
     * 
     * 
                ...
                Runnable runnable = new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            String finalPath = ExpressionData.PATH_TILING_NORM + File.separator;
     ...
     * @param normalization indicates if we use a reference data for normalization or not
     */
    private static void createRnormScript(String listFilesPath, String finalPath, String tempFileName, String tempDir,
        ...
        text += "celDir = \"" + ExpressionData.PATH_TILING_RAW + "\"\n";
    ...
    public static void createFilecatsTable(BioCondition bioCond, String fileName, boolean normalization) {
        ...
        /*
         * If we don't have 3 technical replicates, we create more by copying last RawData
         */
        ...
        if (normalization) {
            ...
            String[] col2 = {"col2", "ADN", "ADN", "ADN", bioCond.getName(), bioCond.getName(), bioCond.getName(), "WT",
                    "WT", "WT"};
            finalColumn1 = col1;
            finalColumn2 = col2;
        } else {
            ...
            String[] colTemp2 = {"col2", "ADN", "ADN", "ADN", bioCond.getName(), bioCond.getName(), bioCond.getName()};
    ...
    public static void createEdgeWT() {
        try {
            String input = ExpressionData.PATH_TILING_NORM + ExpressionData.GENERAL_WT_DATA + ".+" + Tiling.EXTENSION;
            String output = ExpressionData.PATH_TILING_NORM + ExpressionData.GENERAL_WT_NAME + ".+" + Tiling.EXTENSION;
            FileUtils.copy(input, output);
            input = ExpressionData.PATH_TILING_NORM + ExpressionData.GENERAL_WT_DATA + ".-" + Tiling.EXTENSION;
            output = ExpressionData.PATH_TILING_NORM + ExpressionData.GENERAL_WT_NAME + ".-" + Tiling.EXTENSION;
            FileUtils.copy(input, output);
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
    ...
    /**
     * Check temp folder, and GeneExprComplete folder to see if some GeneExpression are not present in
     * GeneExprComplete
     * 
     * @param exp list of all BioCondition to check
     */
    public static void qualityControlNorm(Experiment exp) {
        ...
        File fileNorm = new File(ExpressionData.PATH_TILING_NORM);
