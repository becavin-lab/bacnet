...
public class ArrayExpressDataUtils {
	...
	public static String PATH = ArrayExpress.ARRAYEXPRESS_PATH;

	/**
	 * Read the SDRF table and search for the "Array Design REF" column
	 * 
	 * @param dataID
	 * @return return first value in "Array Design REF" column, empty String
	 *         otherwise
	 */
	...
	public static ArrayList<String> getListData() {
		String[][] array = TabDelimitedTableReader.read(ArrayExpress.DATA_TABLE);
