...
public class ArrayExpressTechnology {
    ...
    public static String PATH =
            Database.getInstance().getPath() + File.separator + "ArrayExpressTechnology" + File.separator;
    ...
    public static String TABLE_PATH =
            Database.getInstance().getPath() + File.separator + "ArrayExpress" + File.separator + "Technologies.txt";
