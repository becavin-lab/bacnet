...
public class ArrayExpressTechnology {
    ...
    public static String PATH = Database.getInstance().getPath() + File.separator + "ArrayExpressTechnology" + File.separator;
    ...
    public static String TABLE_PATH = Database.getInstance().getPath() + File.separator + "ArrayExpress" + File.separator + "Technologies.txt";
    ...
    public static void createHTMLPageSummary() {
       ...
       // TabDelimitedTableReader.saveInHTML(array, Database.getInstance().getPath() + "ListArrays.html",
        ...
        TabDelimitedTableReader.saveInHTML(array, Database.getInstance().getPath() + File.separator + "ArrayExpress/ListArrays.html",
...
//        String fileName = PATH + accession + extension;
    ...
    public static void downloadAllFilesTechno() {
    	String[][] technologies = TabDelimitedTableReader.read(Database.getInstance().getPath() +"/ArrayExpress/Technologies.txt");
    	...
    	for (String techno : list_techno) {
            ...
            if (!pathFile.exists()) {
                ...
                downloadFile(techno, ".reporters.txt", pathFile.getAbsolutePath() + File.separator + techno + ".reporters.txt");
                downloadFile(techno, "_comments.txt", pathFile.getAbsolutePath() + File.separator + techno + "_comments.txt");
                downloadFile(techno, ".compositesequences.txt", pathFile.getAbsolutePath() + File.separator + techno + ".compositesequences.txt");
            }
        }
    }
    ...
    public static void adfCleaning() {
        ...
        for (String techno : list_techno) {
            ...
            for(String line : lines) {
                ...
                if(line.startsWith("Reporter Name")) found = true;
                if(found) newADF.add(line);
            }
