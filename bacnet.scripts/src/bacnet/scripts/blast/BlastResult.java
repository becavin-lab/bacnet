...
public class BlastResult {
    ...
    public void calculateIdentities() {
        identities = ((double) ident * 100) / (queryLength);
    }
            ...
            for (Element iteration : iterations) {
                ...
                for (Element hit : hits) {
                    ...
                    for (Element hsp : hsps) {
                        ...
                        // System.out.println(hit.getChildText("Hit_def").contains("hypothetical
                        // protein"));
                        if (bltResult.hit_def.contains("hypothetical protein")
                                || bltResult.hit_def.contains("predicted protein")) {
                            countHypothetical++;
                        }
                ...
                // System.err.println("ResultsName:
                // "+iteration.getChildText("Iteration_query-def")+" number: "+hits.size() + "
                // hypotethical: "+countHypothetical);
                System.out.println(
                        iteration.getChildText("Iteration_query-def") + "\t" + hits.size() + "\t" + countHypothetical);
    ...
    //
    // /**
    // * Given two BlastResult which should have the same strand and should have been odered properly
    // using BlastResultComparator
    ...
    // * @return
    // */
    // public static String getSequenceBetweenResults(BlastResult bltResult1, BlastResult
    // bltResult2,DNASequence chromosome){
    ...
    // * @return
    // */
    // public static ArrayList<BlastResult> filterAccession(ArrayList<BlastResult> blastResults,String
    // accessionID){
    ...
    // * @return
    // */
    // public static ArrayList<BlastResult> filterEvalue(ArrayList<BlastResult> blastResults,int
    // eValueCutOff){
    // ArrayList<BlastResult> blastResultFiltered = new ArrayList<BlastResult>();
    // for(BlastResult bltResult:blastResults){
    ...
    public static class BlastResultCompare implements Comparator<BlastResult> {
        ...
        public int compare(BlastResult o1, BlastResult o2) {
            ...
            if (o1.strand != o2.strand) {
                System.err.println("Error: Blastresults are not from the same strand");
                return 0;
            } else if (o1.strand) {
