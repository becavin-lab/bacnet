...
public class BlastResultView implements SelectionListener {
    ...
    // private String archiveFile = Blast.getBLAST_RESULT_PATH() +
    // BlastOutput.fileExtension(BlastOutputTYPE.ASN);
    ...
    public void loadBlastData() {
        ...
        // String out = BlastOutput.convertOuput(archiveFile, Blast.getBLAST_RESULT_PATH()+"-out", html,
        // type);
        // browser.setUrl(out);
        //
        // }
