...
public class GenomeNCBIFolderTools {
    ...
    /**
     * Take an array with a list of strain and ftp folders, and: <fi> download them: fna and gff file
     * only <fi> create a folder for each <fi> verify MD5 checksum <fi> unzip files
     * 
     * The strain name should be in the column with the name: strain_name The folder name for the genome
     * to be donwload in should be in the column with the name: folder_name The ftp path should be found
     * in the column with name : ftp_path The id of the assembly should be found in the column with name
     * : assembly_accession
     * 
     * @param tableGenomes
     * @param pathGenomes
    ...
    /**
     * Giving a folderFTP, it will download and unzip: folderFTP+"_assembly_report.txt"
     * folderFTP+"_assembly_stats.txt" folderFTP+"_genomic.fna.gz" folderFTP+"_genomic.gff.gz"
     * "md5checksums.txt"
     * 
     * @param folderFTP
     * @param path
    ...
    /**
     * Go through all folders of Genome directory and extract all TGZ contained in .faa .fna .ffn .frn
     * .gff
     * 
     */
