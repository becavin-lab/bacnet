...
public class BlastOutput {
    ...
    public static String[] outputName = {"pairwise", "query-anchored showing identities",
    ...
    public enum BlastOutputTYPE {
        PAIRWISE, QUERY_SHOW, QUERY, FLAT_SHOW, FLAT, XML, TABLE, TABLE_COMMENT, ASN_TxT, ASN_Bin, COMMA, ASN
    };
