...
//	        // Displaying the newly created tree with Archaeopteryx.
	        org.forester.archaeopteryx.Archaeopteryx.createApplication( phys,Database.getANALYSIS_PATH()+"/Egd-e Annotation/_aptx_configuration_file.txt","Phylogeny with forester");
