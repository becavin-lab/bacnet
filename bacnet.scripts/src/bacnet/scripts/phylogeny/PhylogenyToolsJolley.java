...
/**
 * This list of function is useful to manipulate Newick files given by Jolley in May 2012, from its
 * publication Jolley et al. Microb. 2012<br>
 * It contains 1565 nodes, each bacteria=node has an ID. The link between these ID and an NCBI ID
 * (i.e. NC32010.1) is given by the table at GenomePhylogeny.PATH_INFOTABLE
 * 
...
public class PhylogenyToolsJolley {
    ...
    public static String ALLBACTERIA_NWK_1 =
            Database.getANALYSIS_PATH() + "/Egd-e Annotation/1565_52loci_nucleotides_labels.nwk";
    public static String ALLBACTERIA_NWK_2 =
            Database.getANALYSIS_PATH() + "/Egd-e Annotation/1565_52loci_protein_labels.nwk";
    public static String ALLFIRMICUTES_AVAILABLE =
            Database.getANALYSIS_PATH() + "/Egd-e Annotation/All-Firmicutes-Availables.txt";
    ...
    /**
     * Get a Phylogeny where nodeName contain ID from Jolley and add all taxonomy information contained
     * in it
     * 
     * @return
     */
