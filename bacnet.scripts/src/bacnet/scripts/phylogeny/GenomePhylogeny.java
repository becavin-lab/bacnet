...
public class GenomePhylogeny {
    ...
    /**
     * This table taken from Jolley et al. Microb. 2012, gives info on all bacterial genomes <br>
     * It allows to make link between refSeq or GenBank IDs of genome to different information <br>
     * More specifically it gives the id of each genome in the phylogeny tree of Jolley et al. Microb.
     * 2012
     */
    public static String PATH_INFOTABLE =
            Database.getANALYSIS_PATH() + "/Egd-e Annotation/BIGSdb_10772_1336754328_25031.txt";
     ...
     * 
     * This genome list contains all the genomes both from GenomeFolder and GenomePhylogeny.PATH_TABLE
     * (=All bacteria phylogeny)
     */
