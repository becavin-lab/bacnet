...
public class GenomePhylogeny {
	 ...
	 *  More specifically it gives the id of each genome in the phylogeny tree of Jolley et al. Microb. 2012
	 */
	public static String PATH_INFOTABLE = Database.getANALYSIS_PATH()+"/Egd-e Annotation/BIGSdb_10772_1336754328_25031.txt";
