...
public class PhylogenySmallORFs {
    ...
    public static void run(EPartService partService) {
        ...
        /*
         * ALIGN using ClustalW and create phylogeny file using MEGA6<br> Display phylogeny with FigTree
         */
    ...
    /**
     * reading filtered table and create fasta file, assuming that Lite.excel table have been reduced
     * manually by removing doublons
     */
    ...
    private static ArrayList<String> getAllGenomesFromNewick() {
        ...
        ArrayList<String> genomes1 =
                extractGenomesFromNewick(GenomeNCBIFolderTools.PATH_GENOMES_LIST + "Bacillales.nwk");
        for (String genome : genomes1)
            genomes.add(genome);
        ArrayList<String> genomes2 =
                extractGenomesFromNewick(GenomeNCBIFolderTools.PATH_GENOMES_LIST + "Clostridiales.nwk");
        for (String genome : genomes2)
            genomes.add(genome);
        ArrayList<String> genomes3 =
                extractGenomesFromNewick(GenomeNCBIFolderTools.PATH_GENOMES_LIST + "Lactobacillales.nwk");
