...
public class DNASeqCreation {
    ...
    /**
     * For each RNAseq and Sequence element, calculate the mean value of copy number variation THIS NEED
     * TO BE RUN AFTER CONVERSION of RNASeq files
     */
    public static void calcGeneCNV() {
        ...
        for (String comparison : comparisons) {
            ...
            String[][] cnv1 =
                    TabDelimitedTableReader.read(OmicsData.PATH_NGS_NORM + bioCond1.getName() + NGS.EXTENSION);
            String[][] cnv2 =
                    TabDelimitedTableReader.read(OmicsData.PATH_NGS_NORM + bioCond2.getName() + NGS.EXTENSION);
