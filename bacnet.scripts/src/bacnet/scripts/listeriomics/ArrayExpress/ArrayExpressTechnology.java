...
//		createHTMLPageSummary();
	...
	public static void createTechnoTable(){
		...
		for(String techno : technoMap.keySet()){
			...
			String data = "";
			for(String dataTemp : technoMap.get(techno)) data += dataTemp+"; ";
			String type = "";
			for(String dataTemp : typeMap.get(techno)) type += dataTemp+"; ";
...
//		TabDelimitedTableReader.saveList(idToName, TABLE_PATH);
	...
	public static void 	createHTMLPageSummary(){
		...
		TabDelimitedTableReader.saveInHTML(array, Database.getInstance().getPath()+"ListArrays.html","Listeria Array Designs");	
	}
