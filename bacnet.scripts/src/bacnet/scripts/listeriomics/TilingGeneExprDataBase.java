...
public class TilingGeneExprDataBase {
    ...
    /**
     * This fundamental method create all the files necessary to make Listeriomics software and website
     * work!<br>
     * <br>
     * 
     * @throws Exception
    ...
    public static void run() throws Exception {
        ...
        /*
         * Organized normalized data, this method has to be run when we are sure that normalize(exp) is
         * finished, otherwise it will not be completed
         */
        organizeExpressionData(exp);
        /*
         * Create EGDeWT Mean and Deviation and Convert in streaming data wait for all normalization to
         * finish before converting
         */
        GeneExpression.convert(exp);
        // Tiling.convert(exp);
        /*
         * Create Wild type data which are the total mean on all data WARNING: TAKE VERY LONG LAST RUN:
         * 07/05/2014
         */
    ...
    /**
     * Go through all <code>BioCondition</code> and detect which GeneExpression and Tiling have not been
     * normalized
     * 
     * @param exp
     * @return
