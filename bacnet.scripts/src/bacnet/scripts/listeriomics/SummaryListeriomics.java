...
public class SummaryListeriomics {
	...
	/**
	 * Go through all transcriptomics data and calculate in how many dataset their
	 * expression change for each gene and COG cluster
	 */
	private static void geneFoldChangeStatistics() {
		ExpressionMatrix matrix = ExpressionMatrix
				.load(Database.getLOGFC_MATRIX_TRANSCRIPTOMES_PATH() + "_" + Genome.EGDE_NAME);
