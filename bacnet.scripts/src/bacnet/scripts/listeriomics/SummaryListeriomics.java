...
public class SummaryListeriomics {
    ...
    private static void createSummaryNetwork() {
        ...
        // }
        // }
        // TabDelimitedTableReader.saveList(network, Project.getPath()+"ModifNetworks.sif");
        // TabDelimitedTableReader.saveTreeSet(listnode, Project.getPath()+"ListNode.txt");
    ...
    public static void createBioConditionFigure(boolean transcriptomes) {
        ...
        // TabDelimitedTableReader.saveList(finalNetwork, Project.getPath()+"ModifNetworks.sif");
        ...
        // CircularGenomeJPanel panel = new CircularGenomeJPanel(500, 500, genome, "fj", mutantsSet);
        // try {
        ...
        // String execProcess = "java -jar \"/Applications/cgview/cgview.jar\" -i \""+input+"\" -o
        // \""+output+"\" -f svg";
