...
public class SrnaListeriomics {
    ...
    public static void run() {
        ...
        // GenomeNCBI genomeNCBI = GenomeNCBITools.loadGenome(genomeName, GenomeNCBI.PATH_GENOMES, false,
        // true);
         ...
         * 
         * public static String PATHFigure_Srna = Database.getANNOTATIONDATA_PATH() +
         * "SrnaCircularGenome.png"; public static String PATHFigure_ASrna =
         * Database.getANNOTATIONDATA_PATH() + "ASrnaCircularGenome.png"; public static String
         * PATHFigure_CISReg = Database.getANNOTATIONDATA_PATH() + "CisRegCircularGenome.png"; public static
         * String PATHTABLE_SrnaReference = Database.getANNOTATIONDATA_PATH() + "sRNAReference.txt";
         * 
         */
        ...
        // CircularGenomeJPanel panel = new CircularGenomeJPanel(100, 100,
        // TypeSrna.Srna);
        // try {
        ...
        // //CgviewIO.writeHTMLFile(panel.getCgview(), "img"+File.separator+"Genome
        // sRNAs.png", "PNG",
