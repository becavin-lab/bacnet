...
//        GenomeConversion.run(genomeNCBI, GenomeNCBI.PATH_GENOMES + genomeName, genomeName);
		 ...
		 * Database.getANNOTATIONDATA_PATH() + "ASrnaCircularGenome.png"; public static
		 * String PATHFigure_CISReg = Database.getANNOTATIONDATA_PATH() +
		 * "CisRegCircularGenome.png"; public static String PATHTABLE_SrnaReference =
		 * Database.getANNOTATIONDATA_PATH() + "sRNAReference.txt";
		 * 
		 */
