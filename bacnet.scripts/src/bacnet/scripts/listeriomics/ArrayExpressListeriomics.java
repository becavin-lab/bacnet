...
public class ArrayExpressListeriomics {
    ...
    // "ArrayExpress-Listeria mono-15102014.txt";
    public static String DATA_TABLE = Database.getInstance().getPath() + "/ArrayExpress/ArrayExpress.txt";
     ...
     * We regroupe in this method the many function needed to create the right data.<br>
    ...
    private static void createMatrices() {
        ...
        // JCVI.createMatrix("A-JCVI-21", "E-MEXP-2279"); // E-MEXP-2279 was first
        // manually curated
        // JCVI.extractProbes("A-GEOD-9904", "E-GEOD-19570"); // Did not include all the
        // comparisons
        // available in this experiments, for clarity reasons
