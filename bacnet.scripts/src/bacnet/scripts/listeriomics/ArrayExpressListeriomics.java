...
public class ArrayExpressListeriomics {
    ...
    private static void createMatrices() {
        ...
        // JCVI.extractProbes("A-GEOD-9904", "E-GEOD-19570"); // Did not include all the comparisons
        ...
        // E-MTAB-116 and E-MTAB-118 cannot be processed, cause no normalized data are available
