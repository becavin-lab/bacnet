...
public class GeneralArray {
    ...
    public static void extractProbes(String technoID, String arrayExpressId) {
        ...
        for (String comparison : comparisonToFileName.keySet()) {
            ...
            if (fileNames.size() == 1) {
                System.out.println(ArrayExpressDataUtils.PATH + arrayExpressId + File.separator + fileNames.get(0));
                ...
                if (arrayExpressId.equals("E-GEOD-12634") || arrayExpressId.equals("E-GEOD-11459")) {
                ...
                for (String fileName : fileNames) {
                    ...
                    if (arrayExpressId.equals("E-GEOD-11459") || arrayExpressId.equals("E-GEOD-24107")
                            || arrayExpressId.equals("E-GEOD-12634") || arrayExpressId.equals("E-GEOD-52325")
                            || arrayExpressId.equals("E-GEOD-51193")) {
                        ArrayList<String> includeColNames = new ArrayList<>();
                        includeColNames.add("VALUE");
            ...
            /*
             * Curate data by calculating mean of duplicates
             */
            ExpressionMatrix matrix =
                    ArrayExpress.curateMatrix(ArrayExpress.DATA_CURATED_PATH + comparison + ".txt", true);
