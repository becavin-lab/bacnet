...
public class CUFSL {
     ...
     * @param probe true if we need to extract gene from probe list, false if the matrix contains
     *        already geneId
     * 
     */
    public static void extractProbesComparison(String technoID, String arrayExpressId, boolean probe) {
        ...
        for (String comparison : comparisonToFileName.keySet()) {
            ...
            ExpressionMatrix matrixBioCond =
                    ArrayExpress.curateMatrix(ArrayExpress.DATA_CURATED_PATH + comparison + ".txt", false);
