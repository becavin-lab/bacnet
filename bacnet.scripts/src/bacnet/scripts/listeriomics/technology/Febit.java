...
public class Febit {
	...
	/**
	 * In some column Gene locus name is missing so we add it using EGDe genome and
	 * GenBank ID of each gene
	 * 
	 * @param technoID
	 */
	public static void curateTechnoTable(String technoID) {
		...
		for (int i = 1; i < technoIDArray.length; i++) {
			...
			String genBank = technoIDArray[i][ArrayUtils.findColumn(technoIDArray,
