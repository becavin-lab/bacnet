...
/**
 * List of methods to process TSS, TermSeq, and RiboSeq of Listeriomics Some TSS and NTerm lists
 * were provided in tab-delimited format. Some methods are provided here to construct .wig files
 *
...
public class TSSNTermRiboSeqListeriomics {
    ...
    public static String[] TSS_HEADERS =
            {"EGDe_37C_TSS", "sigB", "prfA", "EGDe_30C", "EGDe_minusO2", "EGDe_Stat", "EGDe_Complete_TSS"};
...
//        }
    ...
    private static void addToFinalData() {
        ArrayList<String> tssList =
                TabDelimitedTableReader.readList(OmicsData.PATH_NGS_RAW + "TSS_expression_across_conditions.txt", true);
