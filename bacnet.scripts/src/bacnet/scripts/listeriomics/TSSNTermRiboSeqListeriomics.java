...
public class TSSNTermRiboSeqListeriomics {
    ...
    public static String[] TSS_HEADERS = {"EGDe_37C_TSS","sigB","prfA","EGDe_30C","EGDe_minusO2","EGDe_Stat","EGDe_Complete_TSS"};
    ...
    private static void addToFinalData() {
        ...
        TabDelimitedTableReader.saveList(tssList, ExpressionData.PATH_NGS_RAW + "TSS_expression_across_conditions.txt");
    }
