...
public class NTermCreateFinalData {
    ...
    /**
     * From the list created by Francis, update all Nterm peptides, indicating which type of TIS
     * (translation initiation sites) they are: annotated TIS multiple TIS updated TIS internal TIS
     * 
    ...
    /**
     * Load list of gene having an updated TIS peptide and search for every NTerm which are exactly at
     * the beginning of the gene or +3 nucleotide after
     */
    ...
    /**
     * Load list of gene having a multiple TIS peptide and search for every NTerm which are exactly at
     * the beginning of the gene or +3 nucleotide after
     */
    ...
    /**
     * Load list of gene having an aTIS peptide and search for every NTerm which are exactly at the
     * beginning of the gene or +3 nucleotide after
     */
    ...
    private void createATISTable() {
        ...
        String header =
                "Gene\tTIS_Name\tFormylation\tFormylated?\trefSequence\tList NTermSequences found\tTotal Spectra\tNTerm Ref Seq\tNTerm ref score\tNterm ref threshold\tUTR length";
        results.add(header);
        for (TIS tis : massSpecDataNew.getTisList()) {
