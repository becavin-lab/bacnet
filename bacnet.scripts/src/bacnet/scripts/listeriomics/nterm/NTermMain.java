...
public class NTermMain {
    ...
    public static void run() {
        ...
        // NTermFilter filter = new
        // NTermFilter(NTermData.load(nameMassSpecData),NTermFilter.DEFAULT_FILTER_PATH);
        // filter.applyFilter();
        ...
        // System.out.println(Genome.loadEgdeGenome().getFirstChromosome().getSequenceAsString(1399327,
        // 1399616, Strand.POSITIVE));
        // System.out.println(">sbrA-50bp");
        // System.out.println(Genome.loadEgdeGenome().getFirstChromosome().getSequenceAsString(1399327,
        // 1399616, Strand.POSITIVE));
        // System.out.println(">rli42-50bp");
        // System.out.println(Genome.loadEgdeGenome().getFirstChromosome().getSequenceAsString(1399461,
        // 1399666, Strand.NEGATIVE));
        // System.out.println(">prfA");
        // System.out.println(Genome.loadEgdeGenome().getFirstChromosome().getSequenceAsString(204353,
        // 204624, Strand.NEGATIVE));
    ...
    public static void findLeaderLess() {
        String[][] array =
                TabDelimitedTableReader.read(NTermUtils.getPATH() + "Statistics/LeaderLess_EGDe_protein.txt");
        ArrayList<String> aTISGenes =
                TabDelimitedTableReader.readList(NTermCreateFinalData.PATH_LIST + "aTIS_Francis_19052015.txt");
        for (int i = 1; i < array.length; i++) {
