...
public class RASToverlap {
    ...
    public static String PATH_Conservation =
            Database.getANALYSIS_PATH() + "Egd-c annotation/Homolog/EGDc_Conservation.txt";
    public static String PATH_Conservation_Cutoff =
            Database.getANALYSIS_PATH() + "Egd-c annotation/Homolog/EGDc_Conservation_cutoff.txt";
    ...
    public static void getOverlap(String nCBIGenome, String rASTGenome, String summaryFileName) {
        ...
        ArrayList<String> noMatch =
                TabDelimitedTableReader.readList(PATH + "comparison/" + summaryFileName + "-noMatch.txt");
    ...
    /**
     * Given a sequence name, it gives the conservation in the three different species, in a
     * String[]:<br>
     * 
    ...
    /**
     * Read "10403S-noMatch-overlap.txt" and add a column indicating if the corresponding lmo gene is
     * kept or not in "EGD-e-noMatch-decision.txt"
     */
    ...
    public static ArrayList<String> getSameEndList(String genome, boolean onlyRAST) {
        ArrayList<String> allElement =
                TabDelimitedTableReader.readList(PATH + "comparison/List " + genome + " sameEnd.txt");
        if (onlyRAST) {
    ...
    public static ArrayList<String> getNotAssociatedList(String genome, boolean onlyRAST) {
        ArrayList<String> allElement =
                TabDelimitedTableReader.readList(PATH + "comparison/List " + genome + " notAssoc.txt");
        if (onlyRAST) {
            ArrayList<String> finalList = new ArrayList<String>();
            for (String element : allElement) {
                if (element.contains("fig"))
    ...
    public static void getEGDeAutoOverlap() {
        ...
        ArrayList<String> finalList =
                TabDelimitedTableReader.readList(PATH + "comparison/" + "EGD-e genes with diff start and overlap.txt");
        int k = 0;
    ...
    public static GenomeNCBI getGenome(String genomeName) {
        ...
        LinkedHashMap<String, ChromosomeBacteriaSequence> chromosomes =
                new LinkedHashMap<String, ChromosomeBacteriaSequence>();
        /*
         * Get sequence
         */
