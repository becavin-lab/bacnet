...
public class SrnaFinalList {
    ...
    /**
     * Read the different :list from different publication and combine all of them into an Srna final
     * list<br>
    ...
    public static void createFinalList() {
        ...
        /*
         * add the list of sRNA from Oliver which have been modified, for each of the rli not in the other
         * lists we align on EGDe, and create a new table with EGDe position of each sRNA Each new Srnas
         * strand is curated by hand directly in the table Thanks to : Srna10403SOliver.findEGDePosition();
         * 
    ...
    private static HashMap<String, ArrayList<Srna>> curateList(HashMap<String, ArrayList<Srna>> listSrnas)
            throws IOException {
        String[][] curateTable =
                TabDelimitedTableReader.read(SrnaTables.PATH + "InfoForTableCuration/sRNA summaryTable.txt");
    ...
    private static ArrayList<Srna> createTotalList(HashMap<String, ArrayList<Srna>> listSrnas) {
        ...
        for (String key : listSrnas.keySet()) {
            ...
            // create ref name
            String[][] reference =
                    TabDelimitedTableReader.read(SrnaTables.PATH + "InfoForTableCuration/sRNA reference.txt");
     ...
     * WARNING: GenomeConversion has to be run before! So we can access to the Srna through
     * <code>Genome.loadEgdeGenome()</code>;
     */
