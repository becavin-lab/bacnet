...
public class SrnaTables {
    ...
    /**
     * Read the different tables from Toledo-Arana publication and create a list of sRNAs from the
     * different tables
     * 
     * @return
     * 
    ...
    /**
     * Read the different tables from Oliver et al. 2009 publication and create a list of sRNAs from the
     * different tables
     * 
     * @return
     * 
    ...
    /**
     * Read the different tables from Mraheil et al. 2011 publication and create a list of sRNAs from
    ...
    /**
     * Read the different tables from Jeff summary table in 2011 and create a list of sRNAs from the
     * different tables
     * 
     * @return
     * 
    ...
    /**
     * Read the different tables from Rfam 2011 data and create a list of sRNAs from the different
     * tables
     * 
     * @return
     * 
    ...
    /**
     * Read the different tables from Wurtezel, Sesto et al. 2012 publication and create a list of sRNAs
