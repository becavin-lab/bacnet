...
public class Srna10403SOliver {
	...
	/**
	 * Run Blast of all Srna found in Oliver et al study against EGD-e and full
	 * 10403S sequence
	 */
	 ...
	 * <br>
	 * 
	 * BE CAREFULL THAT THESE GENOMES HAVE BEEN ESTABLISHED FOR BLAST SEARCH
	 * (=database is created through Blast.createBlastDatabases();)
	 * 
	 */
	 ...
	 * header = {"Srna","EGD-e identites","EGD-e begin","EGD-e end","10403S
	 * identities","10403S begin","10403S end","10403S Average GEI","Delta_sigB
	 * Average GEI","FC range (10403S/Delta_sigB)"};
	 * 
	 * @param sRNAs
	 * @return
	 * @throws IOException
			...
			for (BlastResult blt : results) {
				...
				if (resultsTree.containsKey(blt.hit_accession)) {
					...
					if (evaluePrevious > evalue) {
						String[] result = { blt.eValue + "", blt.identities + "", blt.begin + "", blt.end + "",
								blt.strand + "" };
