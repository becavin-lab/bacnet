...
public class PhylogenyListeriomics {
    ...
    public static void run() {
        ...
        /*
         * In SVG file get the sorted list of genomes and update Genome table accordingly!
         */
        // cleanSVGFile();
    ...
    /*
     * Go through all BlastP datasets and verify that each locus can be found in Listeriomics genomes
     * Save in a file the ocustag to take into account
     */
    ...
    /**
     * Using LOCUSTAG_CHANGE_PATH modify every table by changin locutag ID or removing the row if the
     * gene is not found
     */
    public static void parseData() {
        ...
        for (String genomeId : idToGenome.keySet()) {
            ...
            for (String row : TabDelimitedTableReader
                ...
                /*
                 * Assuming the first hit in the list is always the one with the best score We only take the first
                 * hit of each genome vs genome : query comparison
                 */
        ...
        for (String genomeID : idToGenome.keySet()) {
            ...
            for (int i = 0; i < blastArray.length; i++) {
                ...
                try {
                    ...
                    // System.err.println("Cannot get sequence for: "+blastArray[i][1].split(":")[0]+" "+geneTarget);
                    notFoundLocusTag.add(geneTarget + "\t" + genomeTarget);
                }
                // System.out.println(idToGenome.get(genomeTarget)+" "+" "+geneQuery+" "+geneTarget+"
                ...
                if (geneToHomologs.containsKey(geneQuery)) {
                    ...
                    String info =
                            genomeTarget + ";" + geneTarget + ";" + geneIdentity + ";" + sequenceAAGeneTarget + ";;";
                    geneToHomologs.put(geneQuery, info);
                }
                // TabDelimitedTableReader.saveList(notFoundLocusTag, PATH+"NotFoundLocusTag.txt");
            }
    ...
    /**
     * They used old_locus_tag for the conservation analysis, so we need to create a HashMap to have the
     * equivalent GeneId old_locus_tag ---> locus_tag in the GFF
     */
     ...
     * Names of strain are created in many different "Text table" in the SVG file which have to be
     * removed
     */
    public static void cleanSVGFile() {
        ...
        // if(line.contains("<text transform=") && !line.contains("Phylogenomic distance")){
        // System.out.println(line);
        ...
        //
        // String newLine = line.substring(0, line.indexOf(">"))+" font-family=\"\'MyriadPro-Regular\'\"
    ...
    public static void addPhylogenyToGenes() {
        for (String genomeName : Genome.getAvailableGenomes()) {
            ...
            for (int i = 0; i < blastArray.length; i++) {
                ...
                Gene gene = (Gene) genome.getGeneFromName(locus);
                if (gene != null) {
