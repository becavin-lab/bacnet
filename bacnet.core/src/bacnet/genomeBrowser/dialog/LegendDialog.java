...
public class LegendDialog extends TitleAreaDialog implements SelectionListener {
    ...
    public LegendDialog(Shell parentShell, Track track) {
        ...
        imageChecked = ResourceManager.getPluginImage("bacnet.core", "icons/checked.bmp");
        imageUnchecked = ResourceManager.getPluginImage("bacnet.core", "icons/unchecked.bmp");
    ...
    public void setBioCondition() {
        ...
        for (BioCondition bioCondTemp : track.getDatas().getBioConditionHashMaps().values()) {
            if (bioCondTemp.getName().contains(" vs ")) {
                 ...
                 * First bioCondition
                 */
                BioCondition bioCondition1 =
                        BioCondition.getBioCondition(BioCondition.parseName(bioCondTemp.getName())[0]);
                String row = " " + "\t";
                row += bioCondition1.getName() + "\t";
                String typeDatacontained =
                        bioCondition1.getTypeDataContained().toString().replace('[', ' ').replace(']', ' ');
                 ...
                 * Second bioCondition
                 */
                BioCondition bioCondition2 =
                        BioCondition.getBioCondition(BioCondition.parseName(bioCondTemp.getName())[1]);
                row = "vs" + "\t";
                ...
                String typeDatacontained =
                        bioCondTemp.getTypeDataContained().toString().replace('[', ' ').replace(']', ' ');
