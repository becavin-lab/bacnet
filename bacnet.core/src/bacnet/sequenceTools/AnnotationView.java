            ...
            tableBioCondition.addSelectionChangedListener(new ISelectionChangedListener() {
                ...
                public void selectionChanged(SelectionChangedEvent event) {
                    ...
                    for (int index : viewer.getTable().getSelectionIndices()) {
                        String selectedGene =
                                tableBioCondition.getTable().getItem(index).getText(columnNames.indexOf("Locus tag"));
        ...
        col.setLabelProvider(new ColumnLabelProvider() {
            ...
            public Image getImage(Object element) {
                ...
                if (selectedGenes.contains(bioCond[columnNames.indexOf("Locus tag") - 1])) {
                    ...
                    return ResourceManager.getPluginImage("bacnet.core", "icons/checked.bmp");
                } else {
                    return ResourceManager.getPluginImage("bacnet.core", "icons/unchecked.bmp");
                }
            }
        ...
        if (e.getSource() == btnSaveTxt) {
            ...
            for (int i : tableBioCondition.getTable().getSelectionIndices()) {
                String selectedGenome =
                        tableBioCondition.getTable().getItem(i).getText(columnNames.indexOf("Name") + 1);
