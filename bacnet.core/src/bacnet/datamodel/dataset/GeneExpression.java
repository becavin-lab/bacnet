...
/**
 * 
 * GeneExpression array data from Listeria tiling chip ArrayExpress id : A-AFFY-140
 * 
 * Here double[] values vector has length = 5*probes.size because we put 5 columns column 0-2 = 3
 * replicatas column 3 = median expression column 4 = var expression
 * 
 * @author UIBC
 *
 */
public class GeneExpression extends ExpressionData {
    ...
    /**
     * List all TilingData available by biocondName. Initiate all TilingDataStreaming.
     * 
     * @param geneExp
     * @return
     */
