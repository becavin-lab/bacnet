...
public class OmicsData implements Serializable {
     ...
     */
    public static String PATH_EXPR_RAW =
            Database.getInstance().getPath() + "/RawData" + File.separator + "ExprMatrix" + File.separator;
    /**
     * Folder for all ExpressionMatrix RAW datasets
     */
    public static String PATH_EXPR_NORM =
            Database.getInstance().getPath() + "/NormData" + File.separator + "ExprMatrix" + File.separator;
    /**
     * Folder for all ExpressionMatrix NORM datasets
     */
    public static String PATH_GENEXPR_RAW =
            Database.getInstance().getPath() + "/RawData" + File.separator + "GeneExpr" + File.separator;
    /**
     * Folder for all GeneExpression COMPLETE datasets
     */
    public static String PATH_GENEXPR_COMPLETE =
            Database.getInstance().getPath() + "/NormData" + File.separator + "GeneExprComplete" + File.separator;
    /**
     * Folder for all GeneExpression NORM datasets
     */
    public static String PATH_GENEXPR_NORM =
            Database.getInstance().getPath() + "/NormData" + File.separator + "GeneExpr" + File.separator;
    /**
     * Folder for all Tiling RAW datasets
     */
    public static String PATH_TILING_RAW =
            Database.getInstance().getPath() + "/RawData" + File.separator + "Tiling" + File.separator;
    /**
     * Folder for all Tiling NORM datasets
     */
    public static String PATH_TILING_NORM =
            Database.getInstance().getPath() + "/NormData" + File.separator + "Tiling" + File.separator;
    /**
     * Folder for all RNASeq RAW datasets
     */
    public static String PATH_NGS_RAW =
            Database.getInstance().getPath() + "/RawData" + File.separator + "NGS" + File.separator;
    /**
     * Folder for all RNASeq NORM datasets
     */
    public static String PATH_NGS_NORM =
            Database.getInstance().getPath() + "/NormData" + File.separator + "NGS" + File.separator;
    /**
     * Folder for all Proteome RAW datasets
     */
    public static String PATH_PROTEOMICS_RAW =
            Database.getInstance().getPath() + "/RawData" + File.separator + "Proteome" + File.separator;
    /**
     * Folder for all Proteome NORM datasets
     */
    public static String PATH_PROTEOMICS_NORM =
            Database.getInstance().getPath() + "/NormData" + File.separator + "Proteome" + File.separator;
     ...
     */
    public static int MISSING_VALUE = 0;
