...
public class TabDelimitedTableReader {
    ...
    /**
     * 
     * Read a Tab-delimited file The number of cell in each column has not to be the same When a blank
     * cell is found, it is replace by a void space.
     * 
     * @param file
     ...
     * 
     * @param fileName
     * @param allLine include the all line, or only the first column element of the line (if the file is
     *        a TabDelimited array)
     * @return
     * @throws IOException
     */
    ...
    /**
     * Read a tabdelimited table and extract the line as an ArrayList of String[]<br>
     * Mainly used to load String[][] in SWT table graphic viewer
     * 
     * @param fileName
     * @param allLine include the all line, or only the first column element of the line (if the file is
     *        a TabDelimited array)
     * @param not used but indicates that the lines will be in a vector String[]
     * @return
     * @throws IOException
     */
    ...
    /**
     * Read a tabdelimited table and extract the line as an HashMap<first column, second column> of
     * Strings
     * 
     * @param fileName
     * @return
