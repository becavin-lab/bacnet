...
public class HideExpressionMatrixDialog extends TitleAreaDialog implements SelectionListener {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        btnLoadRow.setImage(ResourceManager.getPluginImage("bacnet.core", "icons/fileIO/sigLoad.bmp"));
        ...
        btnLoadColumn.setImage(ResourceManager.getPluginImage("bacnet.core", "icons/fileIO/sigLoad.bmp"));
