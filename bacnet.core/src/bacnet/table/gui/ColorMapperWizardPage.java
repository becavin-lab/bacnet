...
public class ColorMapperWizardPage extends WizardPage implements Listener {
    ...
    public void createControl(Composite parent) {
        ...
        btnLoadColorMapper.setImage(ResourceManager.getPluginImage("bacnet.core", "icons/fileIO/colLoad.bmp"));
        ...
        btnSaveColorMapper.setImage(ResourceManager.getPluginImage("bacnet.core", "icons/fileIO/colSave.bmp"));
    ...
    /**
     * Give the position in the canvas of a specific value, depending of ColorMapper parameters
     * 
     * @param value
     * @param width
     * @param colorMapper
