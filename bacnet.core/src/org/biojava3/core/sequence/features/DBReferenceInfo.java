...
/**
 * If you have a uniprot ID then it is possible to get a collection of other id(s) that the protein
 * is known by. This is a place holder for the alternative source database and the id for the same
 * protein. Currently implement when the {@link UniprotProxySequenceReader} is used to load a
 * protein sequence
 *
