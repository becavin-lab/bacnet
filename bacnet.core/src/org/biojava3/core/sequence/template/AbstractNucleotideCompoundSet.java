 ...
 *
 * @author Andy Yates
 * @param <C> Type of compound this set will contain but must extend NucleotideCompound
 */
public abstract class AbstractNucleotideCompoundSet<C extends NucleotideCompound> extends AbstractCompoundSet<C> {
    ...
    /**
     * Loops through all known nucelotides and attempts to find which are equivalent to each other. Also
     * takes into account lower casing nucleotides as well as upper-cased ones.
     */
    ...
    /**
     * Calculates the best symbol for a collection of compounds. For example if you gave this method a
     * AC it will return a M which is the ambiguity symbol for these compounds.
     *
