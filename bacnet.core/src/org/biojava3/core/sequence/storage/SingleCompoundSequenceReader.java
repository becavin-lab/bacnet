...
public class SingleCompoundSequenceReader<C extends Compound> implements ProxySequenceReader<C> {
    ...
    /**
     * Returns 1 if the given compound is equal to the one given during construction; otherwise will
     * return -1.
     */
    ...
    /**
     * Returns the length of the Sequence if the given compound was equal to the one given during
     * construction. Otherwise returns -1
     */
