 ...
 * <li>Allow for the fuzzy translation of Codons i.e. if it contains an N that produces a
 * {@link Sequence}&lt;{@link{AminoAcidCompound}&gt; with an X at that position
 * </ul>
 *
 * @author ayates
 */
public class TranscriptionEngine {
    ...
    /**
     * Default instance to use when Transcribing from DNA -&gt; RNA -&gt; Protein. If you require
     * anything that is not a default setting then look at {@ TranscriptionEngine.Builder} for
    ...
    /**
     * Quick method to let you go from a CDS to a Peptide quickly. It assumes you are translating only
     * in the first frame
     *
     ...
     * @return All generated protein sequences in the given frames. Can have null entries
     */
    ...
    public static class Builder {
        ...
        /**
         * The method to finish any calls to the builder with which returns a transcription engine. The
         * engine is designed to provide everything required for transcription to those classes which will
        ...
        /**
         * Uses the static instance of {@link IUPACParser} to find instances of {@link IUPACTable}s by ID.
         */
        ...
        /**
         * Uses the static instance of {@link IUPACParser} to find instances of {@link IUPACTable}s by its
         * String name
         */
        ...
        /**
         * Performs an optimisation where RNASequences are not translated into their own objects but are
         * views onto the base DNA sequence.
         */
