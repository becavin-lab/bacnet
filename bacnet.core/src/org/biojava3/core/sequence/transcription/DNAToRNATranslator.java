 ...
 * delegate to {@link Frame} in order to be in the correctly specified translation frame and then
 * translates T to U. The other translation carried out is to convert an equivalent compound in DNA
 * to RNA i.e. for the base A in DNA fetching the equivalent A base in the RNA {@link CompoundSet}.
 *
 * @author ayates
 */
public class DNAToRNATranslator extends AbstractCompoundTranslator<NucleotideCompound, NucleotideCompound> {
    ...
    /**
     * Overloaded local version which delegates to an optional translator when told to (specified during
     * construction).
     *
     ...
     * {@link RnaSequenceView} as a {@link ProxySequenceReader}.
     */
