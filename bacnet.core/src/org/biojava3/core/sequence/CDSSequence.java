...
/**
 * Represents a exon or coding sequence in a gene. It has a parent {@link TranscriptSequence} where
...
public class CDSSequence extends DNASequence {
    ...
    /**
     * A CDS sequence if negative stranded needs to be reverse complement to represent the actual coding
     * sequence. When getting a ProteinSequence from a TranscriptSequence this method is callled for
     * each CDSSequence {@link http://www.sequenceontology.org/gff3.shtml}
