...
public class DNASequence extends AbstractSequence<NucleotideCompound> {
	 ...
	 */
	public enum DNAType {
		CHROMOSOME, MITOCHONDRIAL, PLASMID, PLASTID, CONTIG, UNKNOWN
	}
...
//        throw new UnsupportedOperationException("Null constructor not supported");
	...
	public static void main(String[] args) {
		...
		StringProxySequenceReader<NucleotideCompound> sequenceStringProxyLoader = new StringProxySequenceReader<NucleotideCompound>(
