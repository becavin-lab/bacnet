...
public class AminoAcidCompoundSet implements CompoundSet<AminoAcidCompound> {
    ...
    private final Map<String, AminoAcidCompound> aminoAcidCompoundCache3Letter =
            new HashMap<String, AminoAcidCompound>();
    ...
    public AminoAcidCompound getCompoundForString(String string) {
        ...
        if (string.length() > this.getMaxSingleCompoundStringLength()) {
            throw new IllegalArgumentException(
                    "String supplied (" + string + ") is too long. Max is " + getMaxSingleCompoundStringLength());
        }
    ...
    // TODO throwing an error seems unnecessary, should this return a boolean
    // instead? maybe rename to isValidSequence?
