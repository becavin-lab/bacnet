...
public interface Sequence<C extends Compound> extends Iterable<C>, Accessioned {
    ...
    /**
     * Does the <em>right thing</em> to get the inverse of the current Sequence. This means either
     * reversing the Sequence and optionally complementing the Sequence.
     */
