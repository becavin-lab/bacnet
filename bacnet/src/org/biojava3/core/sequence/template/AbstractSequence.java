...
public abstract class AbstractSequence<C extends Compound> implements Sequence<C> {
	...
	private ArrayList<FeatureInterface<AbstractSequence<C>, C>> features = new ArrayList<FeatureInterface<AbstractSequence<C>, C>>();
	 ...
	 * possible. A ProxySequenceReader that knows the offset and of teh sequence in
	 * a large fasta file. A ProxySequenceReader that can pull Sequence data from
	 * Uniprot, NCBI or a custom database. If the ProxySequecneReader implements
	...
	/**
	 * Provided for convience if the developer needs to associate data with a
	 * sequence
	 *
	 * @return
	 */
	...
	public void addFeature(int bioStart, int bioEnd, FeatureInterface<AbstractSequence<C>, C> feature) {
		SequenceLocation<AbstractSequence<C>, C> sequenceLocation = new SequenceLocation<AbstractSequence<C>, C>(
				bioStart, bioEnd, this);
