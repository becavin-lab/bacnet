 ...
 *
 * Created on November 19, 2010 Author: Mark Chapman
 */
 ...
 * {@code Profile} data structure in the alignment module provides additional functionality.
 *
 * @author Mark Chapman
...
public interface LightweightProfile<S extends Sequence<C>, C extends Compound> {
    ...
    /**
     * Returns the number of rows in this profile. If any {@link Sequence}s are circular and overlap
     * within the alignment, the returned size will be greater than the number of sequences, otherwise
    ...
    /**
     * Returns a simple view of the alignment profile. This shows each sequence on a separate line (or
     * multiple lines, if circular) and nothing more. This should result in {@link #getSize()} lines
     * with {@link #getLength()} {@link Compound}s per line.
     *
    ...
    /**
     * Returns a formatted view of the alignment profile. This shows the start and end indices of the
     * profile for each group of lines of the given width. Each line may also be labeled.
     *
