...
public class ChromosomeSequence extends DNASequence {
    ...
    /**
     * Empty constructor used by tools that need a proper Bean that allows the actual sequence data to
     * be set after construction. Not recommended
     */
     ...
     * could load from disk via RandomAccessFile so that the sequence doesn't need to be kept in memory.
     * Could also be a NCBI proxy to load sequence data as needed from remote web server.
     * 
     * @param proxyLoader
     */
    ...
    /**
     * Allows the creation of a ChromosomeSequence using String for the sequence with a custom
     * CompoundSet
     * 
     * @param seqString
     * @param compoundSet
    ...
    /**
     * Allows the creation of a ChromosomeSequence using a ProxyResequenceReader for the sequence with a
     * custom CompoundSet
     * 
     * @param proxyLoader
     * @param compoundSet
    ...
    /**
     * Get the list of genes that have been added to the ChromosomeSequence where accession.toString is
     * the key. The list retains the order the genes are added
     * 
     * @return
     */
     ...
     * GeneSequence that is returned will have a reference to parent chromosome sequence which actually
     * contains the sequence data. Strand is important for positive and negative direction where
     * negative strand means we need reverse complement. If negative strand then bioBegin will be
     * greater than bioEnd
     *
     *
     * @param accession
