...
public class RNASequence extends AbstractSequence<NucleotideCompound> {
    ...
    /**
     * Get the inverse view of the sequence. It is the reverse sequence from end to begin where use
     * reverse could imply complement. Called getInverse() in the hopes of making less confusing.
     * 
     * @return
     */
