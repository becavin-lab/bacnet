 ...
 */
public enum Frame {
    ONE(1, false), TWO(2, false), THREE(3, false), REVERSED_ONE(1, true), REVERSED_TWO(2, true), REVERSED_THREE(3,
            true);
    ...
    /**
     * Optionally wraps a Sequence in a reverse complementing view (if the frame is on the reverse
     * strand) and creates a sub sequence view if it is required.
     *
     * If you pass in {@link #ONE} in you will get the same {@link Sequence} returned.
     */
