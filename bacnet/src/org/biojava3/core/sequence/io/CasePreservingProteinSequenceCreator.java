 ...
 * 
 * <p>
 * The user collection will be the same length as the resulting ProteinSequence. Each object can be
 * cast to a Boolean. If true, the corresponding position in the input file was uppercase.
 * 
...
public class CasePreservingProteinSequenceCreator extends ProteinSequenceCreator {
    ...
    /**
     * 
     * @see org.biojava3.core.sequence.io.ProteinSequenceCreator#getSequence(org.biojava3.core.sequence.template.ProxySequenceReader,
     *      long)
     */
    @Override
    ...
    /**
     * Returns a list of Booleans of the same length as the input, specifying whether each character was
     * uppercase or not.
     * 
     * @param str A string. Should not contain unicode supplemental characters.
     * @return a list of Booleans of the same length as the input, specifying whether each character was
     *         uppercase or not. This list contains only Booleans.
     */
     ...
     * {@link CasePreservingProteinSequenceCreator}. Uses the case info stored in the user collection to
