...
public class FastaReaderHelper {
    ...
    /**
     * Selecting lazySequenceLoad=true will parse the FASTA file and figure out the accessionid and
     * offsets and return sequence objects that can in the future read the sequence from the disk. This
     * allows the loading of large fasta files where you are only interested in one sequence based on
     * accession id.
     * 
     * @param file
    ...
    /**
     * Read a fasta file containing amino acids with setup that would handle most cases. User is
     * responsible for closing InputStream because you opened it
     *
     * @param inStream
     * @return
     * @throws Exception
