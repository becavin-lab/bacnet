 ...
 * Foundation prf||name SWISS-PROT sp|accession|name Brookhaven Protein Data
 * Bank (1) pdb|entry|chain Brookhaven Protein Data Bank (2)
 * entry:chain|PDBID|CHAIN|SEQUENCE PDB EBI PDB:1ECY_A mol:protein length:142
 * ECOTIN Patents pat|country|number GenInfo Backbone Id bbs|number General
 * database identifier gnl|database|identifier NCBI Reference Sequence
