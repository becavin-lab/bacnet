 ...
 *         It is therefore advisable to wrap a BufferedReaderBytesRead around
 *         any Reader whose read() operations may be costly, such as FileReaders
 *         and InputStreamReaders. For example,
 *
 *         <pre>
 ...
 *         from the file, converted into characters, and then returned, which
 *         can be very inefficient.
 *
 *         <p>
 *         Programs that use DataInputStreams for textual input can be localized
 *         by replacing each DataInputStream with an appropriate
