...
public class FastaWriterHelper {
    ...
    public static void writeProteinSequence(OutputStream outputStream, Collection<ProteinSequence> proteinSequences)
        ...
        FastaWriter<ProteinSequence, AminoAcidCompound> fastaWriter =
                new FastaWriter<ProteinSequence, AminoAcidCompound>(outputStream, proteinSequences,
    ...
    /**
     * Write a collection of GeneSequences to a file where if the gene is negative strand it will flip
     * and complement the sequence
     * 
     * @param file
     * @param geneSequences
     * @throws Exception
    ...
    public static void writeNucleotideSequence(OutputStream outputStream, Collection<DNASequence> dnaSequences)
        ...
        FastaWriter<DNASequence, NucleotideCompound> fastaWriter = new FastaWriter<DNASequence, NucleotideCompound>(
                outputStream, dnaSequences, new GenericFastaHeaderFormat<DNASequence, NucleotideCompound>());
        fastaWriter.process();
    ...
    /**
     * Method which will write your given Sequences to the specified {@link OutputStream}. This is a
     * very generic method which writes just the AccessionID of the Sequence as the FASTA header.
     *
    ...
    public static void writeSequences(OutputStream outputStream, Collection<Sequence<?>> sequences) throws Exception {
        ...
        FastaWriter<Sequence<?>, Compound> fastaWriter =
                new FastaWriter<Sequence<?>, Compound>(outputStream, sequences, fhfi);
