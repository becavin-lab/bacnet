...
public class FastaWriter<S extends Sequence<?>, C extends Compound> {
    ...
    /**
     * Allow an override of operating system line separator for programs that needs a specific CRLF or
     * CR or LF option
     * 
     * @param lineSeparator
     */
    ...
    public static void main(String[] args) {
        try {
            ...
            FastaReader<ProteinSequence, AminoAcidCompound> fastaReader =
                    new FastaReader<ProteinSequence, AminoAcidCompound>(is,
            ...
            FileOutputStream fileOutputStream =
                    new FileOutputStream("/Users/Scooter/scripps/dyadic/c1-454Scaffolds_temp.faa");
            ...
            FastaWriter<ProteinSequence, AminoAcidCompound> fastaWriter =
                    new FastaWriter<ProteinSequence, AminoAcidCompound>(bo, proteinSequences.values(),
