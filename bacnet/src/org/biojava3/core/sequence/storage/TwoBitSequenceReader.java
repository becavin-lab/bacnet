 ...
 * </ul>
 *
 * We also do not support case sensitive encodings therefore if you pass a lowercased a this will be
 * treated as if it is an uppercase A and we will erase that information.
 *
 * @author ayates
 */
