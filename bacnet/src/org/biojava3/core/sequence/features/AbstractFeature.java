...
public abstract class AbstractFeature<S extends AbstractSequence<C>, C extends Compound>
    ...
    /**
     * A feature could be a single sequence position like a mutation or a post translational
     * modification of an amino acid. It could also be the docking interface of N number of amino acids
     * on the surface. The location wold then be a collection of sequence positions instead of a single
     * sequence position or the begin and end of a sequence seqment.
     * 
     * @return
     */
    ...
    /**
     * A feature can be the child or contained by a parent feature. An example is a Helix feature could
     * contain children features. A PFAM domain could contain secondary structures.
     * 
     * @param feature
     */
    @Override
    ...
    /**
     * Sort features by start position and then longest length. When features are added having them
     * sorted by start position and then longest length helps on the layout of overlapping features so
     * they are delivered in a proper order.
     */
    ...
    /**
     * Sort features by length. //TODO need to handle cases where features have multiple locations,
     * strand etc
     *
     */
    ...
    /**
     * Allow the user to associate an object with the feature. This way if a feature which is displayed
     * in a GUI is clicked on the application can then get a user defined object associated with the
     * feature.
     * 
