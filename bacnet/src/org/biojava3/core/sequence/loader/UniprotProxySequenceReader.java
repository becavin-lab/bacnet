...
public class UniprotProxySequenceReader<C extends Compound>
    ...
    /**
     * The uniprot id is used to retrieve the uniprot XML which is then parsed as a DOM object so we
     * know everything about the protein. If an error occurs throw an exception. We could have a bad
     * uniprot id or network error
     * 
     * @param accession
     * @param compoundSet
     * @throws Exception
    ...
    /**
     * The current unirpot URL to deal with caching issues. www.uniprot.org is loaded balanced but you
     * can access pir.uniprot.org directly.
     * 
    ...
    public static void main(String[] args) {
        ...
        try {
            UniprotProxySequenceReader<AminoAcidCompound> uniprotSequence =
                    new UniprotProxySequenceReader<AminoAcidCompound>("YA745_GIBZE",
