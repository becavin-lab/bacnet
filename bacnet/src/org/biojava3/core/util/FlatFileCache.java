 ...
 * e.g cache gzip compressed PDB files for avoiding disk IO bottlenecks.
 * 
 * @author Andreas Prlic.
 *
 */
public class FlatFileCache {
	...
	public static void addToCache(String key, File fileToCache) {
		// System.out.println("storing " + key + " on file cache (cache size: " +
		// cache.size() + ")");
		try {
	...
	public static InputStream getInputStream(String key) {
		// System.out.println("returning " + key + " from file cache (cache size: " +
		// cache.size() + ")");
