...
public class Equals {
    ...
    /**
     * This method should be called before beginning any equals methods. In order to return true the
     * method:
     *
     * <ol>
     * <li>The two given objects are the same instance using ==. This also means if both Objects are
     * null then this method will return true (well technically they are equal)</li>
     ...
     * @return A boolean indicating if the logic agrees that these two objects are equal at the class
     *         level
     */
