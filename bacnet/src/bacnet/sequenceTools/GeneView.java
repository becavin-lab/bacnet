...
public class GeneView implements SelectionListener, MouseListener {
	...
	public void createPartControl(Composite parent) {
		...
		tableHomologViewer.addDoubleClickListener(new IDoubleClickListener() {
			...
			public void doubleClick(DoubleClickEvent event) {
				String selectedGenome = tableHomologViewer.getTable()
						.getItem(tableHomologViewer.getTable().getSelectionIndex())
						.getText(columnNames.indexOf("Name") + 1);
				String selectedGene = tableHomologViewer.getTable()
						.getItem(tableHomologViewer.getTable().getSelectionIndex())
	...
	/**
	 * When a genome is selected this method will trigger every update possible of
	 * the widgets
	 * 
	 * @param genomeName
	 */
	...
	/**
	 * The comboGenome contains modified genome name so we need this method to get
	 * selected element<br>
	...
	/**
	 * The comboGenome contains modified genome name so we need this method to
	...
	public void widgetSelected(SelectionEvent e) {
		if (e.getSource() == comboGenome) {
			...
			LocalizationDialog dialog = new LocalizationDialog(shell, arrayGeneToLocalization, sequence, bioCondsArray,
					genome);
			dialog.open();
