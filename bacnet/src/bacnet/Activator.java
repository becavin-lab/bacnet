...
public class Activator implements BundleActivator, BundleListener {
    ...
    /**
     * <<<<<<< HEAD Print the type of activation for each bundle <br>
     * Use it only if needed for debugging. Commented otherwise
     * 
     * ======= Print the type of activation for each bundle <br>
     * Use it only if needed for debugging. Commented otherwise >>>>>>> branch 'master' of
     * git@github.com:drbecavin/bacnet-private.git
     * 
     * @param event
     * @return
     */
