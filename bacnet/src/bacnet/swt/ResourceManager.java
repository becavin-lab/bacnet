...
public class ResourceManager extends SWTResourceManager {
    ...
    public static Image decorateImage(final Image baseImage, final Image decorator, final int corner) {
        ...
        if (result == null) {
            ...
            CompositeImageDescriptor compositImageDesc = new CompositeImageDescriptor() {
                 ...
                 * 
                 */
                private static final long serialVersionUID = -6813313714281091894L;
     ...
     * @throws Exception
     */
    public static URL getPluginImageURL(Object plugin, String name) throws Exception {
    ...
    ////////////////////////////////////////////////////////////////////////////
    /**
     * Dispose of cached objects and their underlying OS resources. This should only be called when the
     * cached objects are no longer needed (e.g. on application shutdown).
     */
    ...
    /**
     * Open a HeatMapTranscriptomicsView using EPartService and an id !!!!!! Only for View with option :
     * multiple instance TRUE
     * 
     * @param partService
     * @param id = identifier of the view created
     */
    public static void openView(EPartService partService, String viewID, String secondaryID) {
        MPart part = partService.createPart(viewID);
        part.setElementId(secondaryID);
