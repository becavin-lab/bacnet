...
/**
 * My own implementation of a FastaHeaderParserInterface to parse Fasta files
 * from NCBI ftp
 *
 * NCBI fna (genome and plasmids) gi|gi-number|ref|accession|name
 * gi|16802048|ref|NC_003210.1| Listeria monocytogenes EGD-e, complete genome
 * NCBI ffn (coding) ref|refGenome gi-number|:start-end name
 * ref|NC_003210.1|:318-1673 chromosomal replication initiation protein
 * [Listeria monocytogenes EGD-e] NCBI frn (non-coding) ref|refGenome
 * gi-number|:start-end| name| [locus-tag] ref|NC_003210|:82705-82777|Lys tRNA|
 * [locus_tag=lmot01] NCBI faa (proteins) gi|gi-number|ref|accession|name
 * gi|16802049|ref|NP_463534.1| chromosomal replication initiation protein
...
public class NCBIFastaHeaderParser<S extends AbstractSequence<C>, C extends Compound>
	...
	public void parseHeader(String header, S sequence) {
		...
		if (data.length == 1) {
			/*
			 * Parse fasta header like that: >NZ_HG813249.1 Listeria monocytogenes 6179
			 * chromosome, complete genome By searching if it is starting by a sequence ID
			 * like NZ, CP, or NC
			 */
