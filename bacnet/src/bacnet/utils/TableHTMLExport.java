...
public class TableHTMLExport {
	...
	public static void exportInHTML(JTable table, String fileName) {
		...
		BufferedImage tamponSauvegarde = new BufferedImage(table.getWidth(), table.getHeight(),
		...
		String html = "<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.01 Frameset//\" \"http://www.w3.org/TR/html4/frameset.dtd\">\n<html>\n<head>\n<meta http-equiv=\"Content-Type\" "
