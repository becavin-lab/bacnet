...
/**
 * Vector are array with one dimension like : <code>String[]</code> or
 * <code>double[]</code>
 * 
 * @author UIBC
 *
...
public class VectorUtils {
	 ...
	 * 
	 * @param lists
	 * @return a <code>String[]</code> containing all the elements contained in the
	 *         different lists
	 */
	 ...
	 * Example: quantiles(vector,10)[1] will calculate the 1d decile, the 1d of 10th
	 * quantile<br>
	 * Example: quantiles(vector,100)[5] will calculate the 5d centile, the 5th of
	 * 100th quantile = the 5% cut-off<br>
	 * 
	 * @param vector
	 * @param k
	 * @return
	...
	/**
	 * Return a <code>String</code> representation of the input TreeSet Tab
	 * delimited
	 * 
	 * @param vector
	 * @return
