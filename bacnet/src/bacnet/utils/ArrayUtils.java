...
public class ArrayUtils {
    ...
    /**
     * Return a new Array of String which is the fusion of both array If header = true; the first row of
     * array2 is conserved
     * 
     * @param array
     * @param array2
     ...
     * <br>
     * WARNING: if two values are the same in the column, it will display only the first one with this
    ...
    /**
     * Rescale each Column of the array, at the end all the points as to fill in a cube of diameter
     * gridSize
     * 
     * @param array a double[][] or array
