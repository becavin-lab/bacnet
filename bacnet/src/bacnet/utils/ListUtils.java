...
public class ListUtils {
	...
	/**
	 * The longest common subsequence (or LCS) of groups A and B is the longest
	 * group of elements from A and B that are common between the two groups and in
	 * the same order in each group.<br>
	 ...
	 * CAREFULL: All the String have to come from the same String. This method is
	 * designed to find this "Reference String"
	 * 
	 * @param list
	 * @return
	 */
	...
	/**
	 * Complete a <code>String</code>, by adding elements from another
	 * <code>String</code><br>
