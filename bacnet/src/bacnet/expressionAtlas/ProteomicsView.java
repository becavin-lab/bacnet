...
public class ProteomicsView implements SelectionListener {
			...
			}
			{
				...
				composite_1.setLayout(new GridLayout(2, false));
				{
					...
					btnGenomeViewer.setImage(ResourceManager.getPluginImage("bacnet", "icons/genomeViewer.bmp"));
					{
						...
						GridData gd_lblDisplayTheseBiocondition = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1,
								1);
	...
	private void setData() {
		...
		bioCondsToDisplay = TabDelimitedTableReader.readList(Database.getInstance().getProteomesArrayPath(), true,
				true);
	...
	private class TableLabelProvider extends LabelProvider implements ITableLabelProvider {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -2546838660698175537L;
