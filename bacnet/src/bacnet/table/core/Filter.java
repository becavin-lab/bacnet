...
public class Filter implements Serializable {
    ...
    public static String[] TYPE_REPRESENTATION =
            {"a < Values", "a < |Values|", "a > Values", "a > |Values|", "a < Values < b"};
    ...
    /**
     * Prompt for a filename, and load a scribble from that file. Read compressed, serialized data with
     * a FileInputStream. Uncompress that data with a GZIPInputStream. Deserialize the vector of lines
     * with a ObjectInputStream. Replace current data with new data, and redraw everything.
     */
