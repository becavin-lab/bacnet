...
/**
 * 
 * List of tools useful to extract information hidden in the NoteList of a
 * DNASequence
 * 
 * 
 * @author Chris
...
public class GeneNCBITools {
	 ...
	 * @return value of the attribute ; empty string if the attribute does not
	 *         exists
	 */
	 ...
	 * This method return teh sequence as a StringColor, so codon might be colorized
	 * after
	 * 
	 * @param seq
	 * @return
	 ...
	 * If this distance is under scale, in absolute value, and both gene are on the
	 * same strand, True is return
	 * 
	 * @param gene1
	 * @param gene2
	 * @param scale
	...
	/**
	 * Determine that to gene have the same end if their ending piosition are the
	 * same +- scale bp
	 * 
	 * @param gene1
	 * @param gene2
