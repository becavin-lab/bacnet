...
public class GenomeConversion {
	 ...
	 * <br>
	 * 
	 * Convert a GenomeNCBI into a Genome object -> convert each
	 * ChromosomeBacteriaSequence into Chromosome:<br>
	 * <it> each chromosome sequence are the same
	 * 
	 * <it> coding and noncoding DNASequence are convert into Gene and NcRNA and
	 * serialized <it> sRNA are leaved unchanged <it> Operons, terminator and other
	 * elements are serialized <it> Annotation is created, saved in a table (only
	 * for verification) and serialized
	 * 
	 * @param genomeNCBI
	 * @param genomeName
	 */
	...
	/**
	 * Some Gene name are associated to multiple lmo locus, with this function we
	 * delete gene name if necessary
	 * 
	...
	/**
	 * Get all elements except Coding and NonCoding serialize them, and put them in
	 * Chromosome
	 * 
	 * @param genome
	 * @param genomeNCBI
	...
	/**
	 * Add all elements found in the Chromosome to LinkedHashMap<String, Sequence>
	 * allElements
	 * 
	 * @param genome
	 */
	...
	/**
	 * Create a Table with all elements of the Genome, which will be used for
	 * element search and display on the GenomeViewer
	 * 
	 * @param genome
	 * @param path
	 */
