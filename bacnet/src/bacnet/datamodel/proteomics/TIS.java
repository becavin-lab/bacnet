...
/**
 * This class is used to regroup different Nterm. The assumption is that we regroup in a TIS every
 * Nterm comes from the same peptide but are now different due to proteolysis and C-Terminal ragging
 * 
 * @author UIBC
 *
 */
public class TIS extends Sequence implements Serializable {
    ...
    public void findNTermRef() {
        ...
        /*
         * Find NTerm ref by searching in the right order: - Formylated sequence with highest score -
         * Peptide starting with Methyle amino acid with highest score - Peptide without methyl group with
         * highest score
         */
