...
public class NTerm extends Sequence implements Serializable {
    ...
    public enum ExperimentName {
        Trypsin_Soluble, Trypsin_Insoluble, Trypsin_Actino_Soluble, Trypsin_Actino_Insoluble, GluC_Actino_Soluble, GluC_Actino_Insoluble
    }

    public static String NTERM_PROJECT_BHI = "EGDe_37C_TIS";
    public static String NTERM_PROJECT_SERUM = "Blood_TIS_Final";
    /**
    ...
    /**
     * If the peptide has also been found with MaxQuant analysis software, we write something in this
     * attribute, otherwise its blank
     */
    private String maxQuant = "";
    /**
     * If the peptide has also been found with MaxQuant analysis software, we write something in this
     * attribute, otherwise its blank, each column is for one type of experiments.
     */
