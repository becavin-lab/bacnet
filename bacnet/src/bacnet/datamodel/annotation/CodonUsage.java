...
public class CodonUsage {
    ...
    /**
     * Providing the name of codon Table, it loads the Table and create <code>CodonUsage</code>
     * 
    ...
    /**
     * To verify the codon prediction on EGD-e genome we look at all the genome and count the number of
     * AAA, ATG and CCC codons
     */
