 ...
 * 
 * IMPORTANT, MAJ 04102011 : WT data are only used as indication on experimental
 * design, in all analysis if we want WT we need to add it in the Experiment
 */
public class BioCondition implements Serializable {
	...
	/**
	 * Actual strain used to create this BioCondition, might be different from
	 * genomeName
	 */
	private String genomeUsed = "";
	/**
	 * Type of bioCondition : TSS only, TIS only, RNASeq + Tiling + GeneExpr, RNASeq
	 * only ...
	 */
	...
	/**
	 * True if this BioCondition is a wild-type strain, to be used as a reference
	 * condition
	 */
	...
	/**
	 * Data associated to this BioCondition to use in the case of timepoint
	 * experiment, or same mutant in different condition
	 */
	...
	/**
	 * If it is a mutant, the locus is indicated (example: prfA, lmo0200 or rliA),
	...
	/**
	 * Quantity/properties of drugs added to the media if specified: quantity of
	 * glucose, type of Broth
	 */
	private ArrayList<String> mediaGrowthProperties = new ArrayList<>();
	/**
	 * If it is a proteome, this parameters tells you where in the bacteria cell the
	 * proteins have been extracted
	 */
	private ArrayList<String> localization = new ArrayList<>();
	/**
	 * List of Data for which we have comparison data: This Biocondition vs
	 * BioCondComparison
	 */
	private ArrayList<String> comparisons = new ArrayList<>();
	/**
	 * List of Data for which the BioCondition is the reference bioCodntion for the
	 * comparison: BioCondComparison vs This Biocondition
	 */
	private ArrayList<String> antiComparisons = new ArrayList<>();
	/**
	 * True if no data are associated to this BioCondition<br>
	 * It is used principaly to indicate that the BioCondition is a reference
	 * condition for another BioCondition, and thus no data are available for it, as
	 * the data are in the other BioCondition
	 * 
	 */
	...
	/**
	 * Create a BioCondition containing the different data for comparing this
	 * BioCondition to bioCond2
	 * 
	 * @param bioCond2
	 * @return
	 * @throws IOException
	...
	/**
	 * From a biological condition name, get from the ModelProvider the
	 * corresponding BioCondition object<br>
	 * If not available it will load them for the hard drive
	 * 
	 * @param bioCondName
	 * @param             true if you want to get BioCondition from pre-loaded
	 *                    BioCondition
	 * @return
	 */
	...
	public static ArrayList<String> getAllBioConditionNames() {
		ArrayList<String> listBioConds = TabDelimitedTableReader
				.readList(Database.getInstance().getBioConditionsArrayPath());
		// Remove duplicates
