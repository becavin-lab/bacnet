...
public class Codon {
    ...
    public static String[][] startCodon =
            {{"ATG", "M"}, {"TTG", "L"}, {"CTG", "L"}, {"ATT", "I"}, {"ATC", "I"}, {"ATA", "I"}, {"GTG", "V"}};
    // public static String[][] startCodon = {{"ATG","M"},{"TTG","L"},{"GTG","V"}};
    // public static String[][] startCodon = {{"ATG","M"}};

    public static String[][] aminoacidCharge = {{"R", "1"}, {"H", "1"}, {"K", "1"}, {"D", "-1"}, {"E", "-1"}};

    /**
     * Using aminoacidCharge array, return the value of the charge for each amino acid aminoacidCharge =
     * {{"R","1"},{"H","1"},{"K","1"},{"D","-1"},{"E","-1"}} else =0
     * 
     * @param aa
     * @return
     */
    ...
    /**
     * If it is a start codon return the corresponding codon, an empty <code>String</code> otherwise
     * 
     * @param codon a <code>String</code> of 3 nucleotides
     * @return
     */
    ...
    public static void getCodonProportion(Genome genome, String fileName) {
        String sequence = genome.getFirstChromosome().getSequenceAsString()
                + genome.getFirstChromosome().getReverseComplement().getSequenceAsString();
