...
public class GenomeNCBI {
    ...
    /**
     * Path for all new Genomes : Database.getInstance().getPath() + "/GenomeNCBI/GenomesNew/";
     * This might be used if all IDs have been changed on NCBI servers like it was the cas in Sept 2016
     */
