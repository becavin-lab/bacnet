 ...
 * Main attributes are
 * <code>name, begin, end, strand, genome, and type</code><br>
 * <br>
 * 
...
public class Sequence implements Serializable {
	...
	/**
	 * Anti-SD sequence taken from Correlations between Shine-Dalgarno Sequences and
	 * Gene Features Such as Predicted Expression Levels and Operon Structures Jiong
	 * Ma, Allan Campbell, and Samuel Karlin J. Bacteriol. October 2002 vol. 184 no.
	 * 20 5733-5745
	 */
	 ...
	 * If to < from it will correct automatically the position and strand, to have
	 * from < to
	 * 
	 * @param name
	 * @param begin
	...
	/**
	 * When an Amino Acid sequence contains Stop codon ('*'), this method search the
	 * first start codon and remove sequence before, and then create different
	 * sequence, from one stop codon to the other.
	 * 
	 * @return
	 */
	...
	/**
	 * Get the nucleotide sequence 20bp upstream to the <code>Sequence</code>, +3bp
	 * for including start codon
	 * 
	 * @return
	 */
	...
	/**
	 * Get the nucleotide sequence n bp upstream to the <code>Sequence</code>, +3bp
	 * for including start codon
	 * 
	...
	/**
	 * Get the nucleotide sequence n bp downstream to the <code>Sequence</code>,
	 * +3bp for including start codon
	 * 
	 * @param sizeSD the number of base pair to include before start codon
	 * @return
	 */
	 ...
	 * Then, as we got gene1.begin < gene2.begin, overlap = gene1.end -
	 * gene2.begin<br>
	 * overlap can be negative, it will mean that we have no overlap (gene1.end <
	 * gene2.begin) <br>
	 * or overlap can be higher than gene2.length, in that case overlap =
	 * gene2.length
	 * 
	 * @param gene1
	 * @param gene2
	 ...
	 * First, calculate the overlapping size of two genes, finding the gene upstream
	 * to the other<br>
	 * If overlap is negative it will mean that we have no overlap (gene1.end <
	 * gene2.begin) <br>
	 * 
	 * @param gene1
	 * @param gene2
	 ...
	 * @param sizeStart number of base pair to integrate in the "start region of
	 *                  gene2
	 * @return
	 */
