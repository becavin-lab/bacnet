...
/**
 * List of method for creating EGDe_Mean data: A data created from the mean of all Wild Type data
 * (37C in BHI)
 * 
 * @author UIBC
 *
...
public class EGDeWTdata {
     ...
     */
    public static String[] wildTypes = {"EGDe-010910-Porto", "EGDe_010910", "EGDe_021012", "EGDe_030510", "EGDe_050609",
            "EGDe_090610", "EGDe_121109", "EGDe_130911", "EGDe_171111", "EGDe_180110", "EGDe_241109", "EGDe_270407",
            "EGDe_270911", "EGDe_280212"};

    /**
     * From the list of Wild Type data given by <code>EGDeWTdata.wildTypes</code> calculate the mean and
     * save it
     * 
     */
    public static void createEGDeAverage() {
        ...
        /*
         * Create a BioCondition and data corresponding containing the stat devition of expression
         */
