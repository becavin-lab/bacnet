 ...
 * As soon as a position in double[] values has been read, boolean[] read is
 * updated <br>
 * 
 * 
 * @author Chris
...
public class ExpressionData extends OmicsData implements Serializable {
	...
	/**
	 * Array used during streaming reading, to indicate wether or not a part of the
	 * data has been read
	 */
	...
	/**
	 * Load information on the data: name, date, note, stat, etc ... The path for
	 * data loading will be: PATH_STREAMING+this.getName()+"Info"+this.EXTENSION;
	 */
	public void load() {
	 ...
	 * It is a streaming reading so it check if the data are already read or not and
	 * act consequently
	 * 
