...
public class NTerminomicsView implements SelectionListener {
		...
		btnSaveTxt.addSelectionListener(this);
		{
			...
			tableBioCondition.addSelectionChangedListener(new ISelectionChangedListener() {
				...
				public void selectionChanged(SelectionChangedEvent event) {
					...
					String peptideID = tableBioCondition.getTable().getItem(i)
							.getText(columnNames.indexOf("PeptideID"));
	...
	private void setData() {
		 ...
		 * Load Table
		 */
		String nterminomeArrayPath = Database.getInstance().getPath()
				+ Database.getInstance().getDatabaseFeatures().get("NTERM_ARRAY");
