...
public class Zoom implements Serializable, Cloneable {
	...
	/**
	 * Search the zoom position which correspond the best to displayRegion
	 * DisplayRegion should be inferior to display range given by the zoom
	 * 
	 * @param displayRegion
	 */
	...
	public String toString() {
		String ret = "ZoomPos " + zoomPosition + " zoomNB " + zoomNumber + " zoomRatio " + zoomRatio + " totBP "
				+ totalBP;
		return ret;
	}
