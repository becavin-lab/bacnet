...
/**
 * A TrackCanvasGenome is the Canvas in which will be displayed genome
 * annotation
 * 
...
public class TrackCanvasGenome extends Canvas implements MouseMoveListener {
	...
	public TrackCanvasGenome(Composite parent, int style) {
		...
		this.addListener(SWT.Resize, new Listener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 1937077139006977978L;
	...
	private void setVerticalDisplayParameter(GC gc) {
		...
		// System.out.println("element: "+annotElementHeight+" sep
	...
	private void displayAnnotation(GC gc) {
		...
		for (Sequence sequence : sequences) {
			...
			case Srna: // sRNA and riboswitch
				...
				GElement.displayGene(gc, sequence, rectangleSrna, track, lightColor, darkColor, lineColor, textColor,
						false);
				break;
			case Operon: // Operon
