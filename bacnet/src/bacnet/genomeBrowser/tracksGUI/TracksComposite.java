...
/**
 * In TracksComposite both <code>TrackCanvasData</code> and
 * <code>TrackCanvasGenome</code> will be displayed. It is the whole genbome
 * viewer canvas
 * 
...
public class TracksComposite extends Composite implements SelectionListener, MouseListener {
	...
	/**
	 * Depending on <code>Track</code> parameters (<code>Region</code> and
	 * <code>Zoom</code>) fix properties of HorizontalBar
	 */
	...
	/**
	 * Display a specific element of the genome only by data.getDisplay() to false,
	 * except in the region of the genomeElement
	 * 
	 * @param text
	 */
