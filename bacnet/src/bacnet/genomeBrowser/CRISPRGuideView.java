...
public class CRISPRGuideView implements SelectionListener {
    ...
    public void createPartControl(Composite parent) {
        ...
        {
            tableBioCondition = new TableViewer(compositeSummary, SWT.BORDER | SWT.FULL_SELECTION | SWT.MULTI | SWT.VIRTUAL);
            ...
            tableBioCondition.addSelectionChangedListener(new ISelectionChangedListener() {
                ...
                public void selectionChanged(SelectionChangedEvent event) {
                    ...
                    int guidePosition = Integer.parseInt(
                            tableBioCondition.getTable().getItem(i).getText(columnNames.indexOf("Start")));
