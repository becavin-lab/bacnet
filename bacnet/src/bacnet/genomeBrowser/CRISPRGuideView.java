...
public class CRISPRGuideView implements SelectionListener {
	...
	public void createPartControl(Composite parent) {
		...
		{
			tableBioCondition = new TableViewer(compositeSummary,
	...
	private void setData() {
		 ...
		 * Load Table
		 */
		String cripsguideArrayPath = Database.getANNOTATIONDATA_PATH()
				+ Database.getInstance().getDatabaseFeatures().get("GUIDES");
